...
{
    public class ListReader<T> : ExcelListWrap
    {
        public ListReader(IWorkbook workbook, int titleIndex) : base(workbook, titleIndex, typeof(T))
        {
        ...
        /// 从文件中生成 ExcelWrap
        /// </summary>
        public static ListReader<T> FromFile(Stream file, string fileName, int titleIndex)
        {
            ...
            return new ListReader<T>(book, titleIndex);
        }
    ...
    public class ExcelListWrap
    {
        ...
        /// 获取数据集合
        /// </summary>
        public ExcelListWrap(IWorkbook workbook, int titleIndex, Type type)
        {
            _workbook = workbook;
